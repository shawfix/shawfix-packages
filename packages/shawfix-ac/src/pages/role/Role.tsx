...
export default function Role(): React.ReactNode {
  ...
  return (
    <div className="flex flex-col gap-6 px-4 py-4 w-full h-full bg-white rounded-lg">
      <Form
      ...
      <div className="flex-1 flex flex-col gap-2 h-0">
        <Row>
          <Space>
        ...
        <Table<UserResponse>
          className="ant-table-wrapper-flexible"
          dataSource={dataSource}
          columns={columns}
          rowSelection={rowSelection}
          scroll={{ x: 'max-content', y: 'unset' }}
        ></Table>
      </div>
    </div>
  );
